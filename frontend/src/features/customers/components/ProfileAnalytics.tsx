...
export function ProfileAnalytics({ totalJobs = 0, activeJobs = 0 }: ProfileAnalyticsProps) {
  const analytics = [
    { label: "Customer Rating", value: "4.8", icon: Star, change: "Based on 0 reviews" },
    { label: "Trust Score", value: "95/100", icon: Award, change: "Highly trusted profile" },
    { label: "Total Jobs Posted", value: totalJobs.toString(), icon: Briefcase, change: `${activeJobs} active, ${totalJobs - activeJobs} completed` },
  ];
